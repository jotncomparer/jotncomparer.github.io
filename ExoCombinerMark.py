...
def ExoCombinerMark():
    ...
    markExotics = {"Response": []}

    markExotics['Response'].append(items1)
    markExotics["Response"].append(items2)
    markExotics["Response"].append(items3)

    with open('markExotics.json', "w") as f:
        f.write(json.dumps(markExotics, indent=2))

    exotic_len_1 = len(markExotics["Response"][0]['weapons'])
    exotic_len_2 = len(markExotics["Response"][1]['weapons'])
    exotic_len_3 = len(markExotics["Response"][2]['weapons'])
    ...
    for number in range(0, exotic_len_1):
        Name_1 = markExotics["Response"][0]["weapons"][number]["referenceId"]
        Kills_1 = markExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_1 = \
            markExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_2):
        Name_2 = markExotics["Response"][1]["weapons"][number]["referenceId"]
        Kills_2 = markExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_2 = \
            markExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_3):
        Name_3 = markExotics["Response"][2]["weapons"][number]["referenceId"]
        Kills_3 = markExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_3 = \
            markExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
