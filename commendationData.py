...
def commendationData():
    ...
    guardianRank = metric_json["Response"][0]['profile']['data']['currentGuardianRank']
    guardianRankTitle = 0
    if guardianRank <= 6:
        guardianRankTitle = 'Blueberry'
    elif guardianRank == 7:
        guardianRankTitle = 'Elite'
    elif guardianRank == 8:
        guardianRankTitle = 'Justiciar'
    elif guardianRank == 9:
        guardianRankTitle = 'Vanquisher'
    elif guardianRank == 10:
        guardianRankTitle = 'Exemplar'
    elif guardianRank == 11:
        guardianRankTitle = 'Paragon'

    print(f'Guardian Rank: {guardianRank} - {guardianRankTitle}')
    ...
    leadershipScore = metric_json["Response"][0]['profileCommendations']['data']['commendationNodeScoresByHash'][
        '1390663518']
    masteryScore = metric_json["Response"][0]['profileCommendations']['data']['commendationNodeScoresByHash'][
        '4180748446']
    # Commendation Percentage by Types
    allyPercent = metric_json["Response"][0]['profileCommendations']['data']['commendationNodePercentagesByHash'][
        '154475713']
    funPercent = metric_json["Response"][0]['profileCommendations']['data']['commendationNodePercentagesByHash'][
        '1341823550']
    leadershipPercent = metric_json["Response"][0]['profileCommendations']['data']['commendationNodePercentagesByHash'][
        '1390663518']
    masteryPercent = metric_json["Response"][0]['profileCommendations']['data']['commendationNodePercentagesByHash'][
        '4180748446']
    ...
    bestDressedScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '357212819']
    primevalInstinctScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '363818544']
    indispensableScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '2019871317']
    patientConsiderateScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '2506835299']
    levelHeadedScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '3037314846']
    joyBringerScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '3377580220']
    thoughfulScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '3513056018']
    heroicScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash']['3575743922']
    perceptiveScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '3872064891']
    knowledgeableScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '3970150545']
    playmakerScore = metric_json["Response"][0]['profileCommendations']['data']['commendationScoresByHash'][
        '4209356036']
