...
def ExoCombinerHunt():
    ...
    hunterExotics = {"Response": []}

    hunterExotics['Response'].append(items1)
    hunterExotics["Response"].append(items2)
    hunterExotics["Response"].append(items3)

    with open('hunterExotics.json', "w") as f:
        f.write(json.dumps(hunterExotics, indent=2))

    exotic_len_1 = len(hunterExotics["Response"][0]['weapons'])
    exotic_len_2 = len(hunterExotics["Response"][1]['weapons'])
    exotic_len_3 = len(hunterExotics["Response"][2]['weapons'])
    ...
    for number in range(0, exotic_len_1):
        Name_1 = hunterExotics["Response"][0]["weapons"][number]["referenceId"]
        Kills_1 = hunterExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_1 = \
            hunterExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_2):
        Name_2 = hunterExotics["Response"][1]["weapons"][number]["referenceId"]
        Kills_2 = hunterExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_2 = \
            hunterExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_3):
        Name_3 = hunterExotics["Response"][2]["weapons"][number]["referenceId"]
        Kills_3 = hunterExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_3 = \
            hunterExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
