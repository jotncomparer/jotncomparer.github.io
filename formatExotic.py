...
with open('static/data/playerExoticData/hunterExotics.json', 'r') as api_file:
...
with open('static/data/formattedPlayerExoticData/formattedHunterExotics.json', 'r') as exotic_file:
...
with open('static/data/formattedPlayerExoticData/formattedHunterExotics.json', 'w') as exotic_file:
