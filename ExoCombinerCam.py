...
def ExoCombinerCam():
    ...
    cameronExotics = {"Response": []}

    cameronExotics['Response'].append(items1)
    cameronExotics["Response"].append(items2)
    cameronExotics["Response"].append(items3)

    with open('cameronExotics.json', "w") as f:
        f.write(json.dumps(cameronExotics, indent=2))

    exotic_len_1 = len(cameronExotics["Response"][0]['weapons'])
    exotic_len_2 = len(cameronExotics["Response"][1]['weapons'])
    exotic_len_3 = len(cameronExotics["Response"][2]['weapons'])
    ...
    for number in range(0, exotic_len_1):
        Name_1 = cameronExotics["Response"][0]["weapons"][number]["referenceId"]
        Kills_1 = cameronExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_1 = \
            cameronExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_2):
        Name_2 = cameronExotics["Response"][1]["weapons"][number]["referenceId"]
        Kills_2 = cameronExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_2 = \
            cameronExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_3):
        Name_3 = cameronExotics["Response"][2]["weapons"][number]["referenceId"]
        Kills_3 = cameronExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_3 = \
            cameronExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
