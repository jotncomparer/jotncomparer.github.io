...
def ExoCombinerKade():
    ...
    kadeExotics = {"Response": []}

    kadeExotics['Response'].append(items1)
    kadeExotics["Response"].append(items2)
    kadeExotics["Response"].append(items3)

    with open('kadeExotics.json', "w") as f:
        f.write(json.dumps(kadeExotics, indent=2))

    exotic_len_1 = len(kadeExotics["Response"][0]['weapons'])
    exotic_len_2 = len(kadeExotics["Response"][1]['weapons'])
    exotic_len_3 = len(kadeExotics["Response"][2]['weapons'])
    ...
    for number in range(0, exotic_len_1):
        Name_1 = kadeExotics["Response"][0]["weapons"][number]["referenceId"]
        Kills_1 = kadeExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_1 = \
            kadeExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_2):
        Name_2 = kadeExotics["Response"][1]["weapons"][number]["referenceId"]
        Kills_2 = kadeExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_2 = \
            kadeExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_3):
        Name_3 = kadeExotics["Response"][2]["weapons"][number]["referenceId"]
        Kills_3 = kadeExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_3 = \
            kadeExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
