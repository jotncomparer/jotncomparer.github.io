...
def ExoCombinerNoz():
    ...
    nozExotics['Response'].append(items1)
    nozExotics["Response"].append(items2)
    nozExotics["Response"].append(items3)

    with open('nozExotics.json', "w") as f:
        f.write(json.dumps(nozExotics, indent=2))

    exotic_len_1 = len(nozExotics["Response"][0]['weapons'])
    exotic_len_2 = len(nozExotics["Response"][1]['weapons'])
    exotic_len_3 = len(nozExotics["Response"][2]['weapons'])
    ...
    for number in range(0, exotic_len_1):
        Name_1 = nozExotics["Response"][0]["weapons"][number]["referenceId"]
        Kills_1 = nozExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_1 = \
            nozExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_2):
        Name_2 = nozExotics["Response"][1]["weapons"][number]["referenceId"]
        Kills_2 = nozExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_2 = \
            nozExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_3):
        Name_3 = nozExotics["Response"][2]["weapons"][number]["referenceId"]
        Kills_3 = nozExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_3 = \
            nozExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
