...
def ClanExoCombiner():
    ...
    Primary.add_column("Exotic", ["Sweet Business", "Sturm", "Vigilance Wing", "Rat King", "MIDA Multi-Tool", "Crimson",
                                  ...
                                  strand("Quicksilver Storm"), "Revision Zero", strand("Final Warning"),
                                  stasis("Verglas Curve"),
                                  stasis("Wicked Implement"),
                                  void("Fighting Lion"), solar("Sunshot"), solar("Skyburner's Oath"),
                                  void('Graviton Lance'), arc("Riskrunner"),
                                  void("Hard Light"),
                                  solar("Polaris Lance"),
                                  arc("Trinity Ghoul"), void("Le Monarque"), solar("Tarrabah"), arc("Symmetry"),
                                  solar("Devil's Ruin"),
                                  solar("Tommy's Matchbook"),
                                  solar("Ticuu's Divination"), solar("Vex Mythoclast"), void("Collective Obligation"),
                                  arc("Trespasser"),
    ...
    Primary.add_column("Element",
                       ["Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic",
                        ...
                        "Kinetic", "Kinetic", strand("Kinetic/Strand"), "Kinetic", strand("Strand"), stasis("Stasis"),
                        stasis("Stasis"),
                        void("Void"), solar("Solar"), solar("Solar"), void('Void'), arc("Arc"),
                        void("Arc/Void/Solar"), solar("Solar"), arc("Arc"), void("Void"),
                        solar("Solar"), arc("Arc"), solar("Solar"), solar("Solar"), solar("Solar"), solar("Solar"),
                        void("Void"),
    ...
    Primary.add_column("Kills",
                       [sweetBusiness.kills, sturm.kills, vigilance.kills, ratKing.kills, mida.kills, crimson.kills,
                        ...
                        chosen.kills, hawkmoon.kills, notime.kills, deadmans.kills, cryo.kills, osteo.kills,
                        touch.kills,
                        quicksilver.kills, revision.kills, warning.kills, verglas.kills, wicked.kills, fighting.kills,
                        sunshot.kills, skyburner.kills, graviton.kills, riskrunner.kills, hardlight.kills,
                        polaris.kills,
                        trinity.kills, lemon.kills, tarrabah.kills, symmetry.kills, devil.kills, tommys.kills,
                        ticuu.kills,
                        mythoclast.kills, obligation.kills, trespass.kills, manticore.kills, hierarchy.kills,
                        centrifuse.kills])
    Primary.add_column("Precision Kills",
                       [sweetBusiness.prec, sturm.prec, vigilance.prec, ratKing.prec, mida.prec, crimson.prec,
                        ...
                        mythoclast.prec, obligation.prec, trespass.prec, manticore.prec, hierarchy.prec,
                        centrifuse.prec])
    ...
    Special.add_column("Exotic",
                       ["The Chaperone", "Izanagi's Burden", "Arbalest", "Bastion", "Witherhoard",
                        stasis("Ager's Scepter"),
                        "Forerunner", stasis("Conditional Finality"), strand("The Navigator"), arc("Coldheart"),
                        solar("Merciless"), void("Borealis"),
                        solar("Prometheus Lens"), void("Telesto"), void("Wavesplitter"), solar("Lord of Wolves"),
                        solar("Jötunn"), solar("Eriana's Vow"),
                        arc("Divinity"), arc("The Fourth Horseman"), void("Ruinous Effigy"), solar("Duality"),
                        arc("Cloudstrike"),
    ...
    Special.add_column("Precision Kills",
                       [chaperone.prec, izan.prec, arbalest.prec, bastion.prec, witherhoard.prec, agers.prec,
                        forerunner.prec,
    ...
    Heavy.add_column("Exotic",
                     [arc("The Wardcliff Coil"), void("Tractor Cannon"), arc("Legend of Acrius"), arc("D.A.R.C.I."),
                      void("The Colony"), arc("Worldline Zero"), solar("Sleeper Simulant"),
                      solar("One Thousand Voices"), void("Two-Tailed Fox"),
                      void("Black Talon"), arc("The Queenbreaker"), arc("Thunderlord"), arc("Anarchy"),
                      void("Leviathan's Breath"),
                      solar("Xenophage"), void("Deathbringer"), solar("Heir Apparent"), stasis("Salvation's Grip"),
                      solar("Eyes of Tomorrow"),
                      solar("The Lament"), solar("Gjallarhorn"), solar("Parasite"), arc("Grand Overture"),
                      void("Heartshadow"),
    ...
    Heavy.add_column("Precision Kills",
                     [wardcliff.prec, tractor.prec, acrius.prec, darci.prec, colony.prec, worldline.prec,
                      ...
                      thunderlord.prec, anarchy.prec, leviathan.prec, xeno.prec, deathbringer.prec, heir.prec,
                      salvation.prec,
    ...
    Full.add_column("Exotic", ["Sweet Business", "Sturm", "Vigilance Wing", "Rat King", "MIDA Multi-Tool", "Crimson",
                               ...
                               strand("Quicksilver Storm"), "Revision Zero", strand("Final Warning"),
                               stasis("Verglas Curve"),
                               stasis("Wicked Implement"), void("Fighting Lion"), solar("Sunshot"),
                               solar("Skyburner's Oath"), void('Graviton Lance'),
                               ...
                               solar("Tommy's Matchbook"), solar("Ticuu's Divination"), solar("Vex Mythoclast"),
                               void("Collective Obligation"),
                               arc("Trespasser"),
                               void("The Manticore"), solar("Hierarchy of Needs"), arc("Centrifuse"), "The Chaperone",
                               "Izanagi's Burden",
                               "Arbalest", "Bastion", "Witherhoard", stasis("Ager's Scepter"),
                               "Forerunner", stasis("Conditional Finality"), strand("The Navigator"), arc("Coldheart"),
                               solar("Merciless"),
                               void("Borealis"), solar("Prometheus Lens"), void("Telesto"), void("Wavesplitter"),
                               solar("Lord of Wolves"), solar("Jötunn"),
                               solar("Eriana's Vow"),
                               arc("Divinity"), arc("The Fourth Horseman"), void("Ruinous Effigy"), solar("Duality"),
                               arc("Cloudstrike"),
                               void("Lorentz Driver"), solar("Edge of Intent"),
                               void("Dead Messenger"), arc("Delicate Tomb"), void("Vexcalibur"),
                               arc("The Wardcliff Coil"), void("Tractor Cannon"), arc("Legend of Acrius"),
                               arc("D.A.R.C.I."),
                               void("The Colony"), arc("Worldline Zero"), solar("Sleeper Simulant"),
                               solar("One Thousand Voices"),
                               void("Two-Tailed Fox"), void("Black Talon"), arc("The Queenbreaker"), arc("Thunderlord"),
                               arc("Anarchy"),
                               void("Leviathan's Breath"),
                               solar("Xenophage"), void("Deathbringer"), solar("Heir Apparent"),
                               stasis("Salvation's Grip"), solar("Eyes of Tomorrow"),
                               solar("The Lament"), solar("Gjallarhorn"), solar("Parasite"), arc("Grand Overture"),
                               void("Heartshadow"),
                               void("Deterministic Chaos"), stasis("Winterbite"), void("Truth"),
                               solar("Whisper of the Worm")])
    Full.add_column("Element", ["Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic",
                                ...
                                stasis("Stasis"),
                                "Kinetic", "Kinetic", strand("Kinetic/Strand"), "Kinetic", strand("Strand"),
                                stasis("Stasis"), stasis("Stasis"),
                                void("Void"), solar("Solar"), solar("Solar"), void('Void'), arc("Arc"),
                                void("Arc/Void/Solar"), solar("Solar"), arc("Arc"), void("Void"),
                                solar("Solar"),
                                arc("Arc"), solar("Solar"), solar("Solar"), solar("Solar"), solar("Solar"),
                                void("Void"), arc("Arc"), void("Void"), solar("Solar"), arc("Arc"),
                                "Kinetic", "Kinetic", "Kinetic", "Kinetic", "Kinetic", stasis("Stasis"), "Kinetic",
                                stasis("Stasis/Solar"), strand("Strand"), arc("Arc"), solar("Solar"),
                                void("Arc/Void/Solar"), solar("Solar"), void("Void"), void("Void"),
                                solar("Solar"), solar("Solar"), solar("Solar"), arc("Arc"), arc("Arc"), void("Void"),
                                solar("Solar"), arc("Arc"), void("Void"), solar("Solar"),
                                void("Arc/Void/Solar"), arc("Arc"), void("Void"), arc("Arc"), void("Void"), arc("Arc"),
                                arc("Arc"),
                                void("Void"), arc("Arc"), solar("Solar"), solar("Solar"), void("Arc/Void/Solar"),
                                void("Void"), arc("Arc"), arc("Arc"), arc("Arc"), void("Void"), solar("Solar"),
                                void("Void"), solar("Solar"), stasis("Stasis"), solar("Solar"),
                                solar("Solar"), solar("Solar"), solar("Solar"), arc("Arc"), void("Void"), void("Void"),
                                stasis("Stasis"), void("Void"), "Void"])
    ...
    Full.add_column("Kills",
                    [sweetBusiness.kills, sturm.kills, vigilance.kills, ratKing.kills, mida.kills, crimson.kills,
                     ...
                     obligation.kills, trespass.kills, manticore.kills, hierarchy.kills, centrifuse.kills,
                     chaperone.kills,
                     ...
                     wardcliff.kills, tractor.kills, acrius.kills, darci.kills, colony.kills, worldline.kills,
                     sleeper.kills,
                     thousand.kills, twotailed.kills, black.kills, queenbreak.kills, thunderlord.kills, anarchy.kills,
                     leviathan.kills, xeno.kills, deathbringer.kills, heir.kills, salvation.kills, eyesof.kills,
                     lament.kills,
                     gjallar.kills, parasite.kills, overture.kills, heartshadow.kills, determine.kills,
                     winterbite.kills,
    ...
    Full.add_column("Precision Kills",
                    [sweetBusiness.prec, sturm.prec, vigilance.prec, ratKing.prec, mida.prec, crimson.prec, rabbit.prec,
                     ...
                     quicksilver.prec, revision.prec, warning.prec, verglas.prec, wicked.prec, fighting.prec,
                     sunshot.prec,
                     skyburner.prec, graviton.prec, riskrunner.prec, hardlight.prec, polaris.prec, trinity.prec,
                     lemon.prec,
                     tarrabah.prec, symmetry.prec, devil.prec, tommys.prec, ticuu.prec, mythoclast.prec,
                     obligation.prec,
                     trespass.prec, manticore.prec, hierarchy.prec, centrifuse.prec, chaperone.prec, izan.prec,
                     arbalest.prec, bastion.prec, witherhoard.prec, agers.prec, forerunner.prec, finality.prec,
                     navigator.prec,
                     coldheart.prec, merciless.prec, bore.prec, prometheus.prec, telesto.prec, wavesplit.prec,
                     lordofwolves.prec, jotunn.prec, eriana.prec, divinity.prec, fourthhorse.prec, ruinous.prec,
                     duality.prec,
                     ...
                     queenbreak.prec, thunderlord.prec, anarchy.prec, leviathan.prec, xeno.prec, deathbringer.prec,
                     heir.prec,
