...
def oneCharTwoPages(membershipType, destinyMembershipId, characterId, MODE):
    if MODE == 4:
        ...
        oneCharRaid.add_row(
            ["Leviathan", Levi_Start, Levi_Comp, Levi_Tot_K, Levi_Tot_D, Time_Converter(Levi_Tot_Time)])
        oneCharRaid.add_row(["Eater of Worlds", EoW_Start, EoW_Comp, EoW_Tot_K, EoW_Tot_D,
                             Time_Converter(EoW_Tot_Time)])
        oneCharRaid.add_row(
            ["Spire of Stars", SoS_Start, SoS_Comp, SoS_Tot_K, SoS_Tot_D, Time_Converter(SoS_Tot_Time)])
        ...
        oneCharRaid.add_row(
            ["Vault of Glass", VoG_Start, VoG_Comp, VoG_Tot_K, VoG_Tot_D, Time_Converter(VoG_Tot_Time)])
    ...
    if MODE == 82:
        ...
        for number in range(0, activities_len_1):
            ...
            Dungeon_Kills_1 = Dungeon_data_json["Response"][0]["activities"][number]["values"]["kills"]["basic"][
                "value"]
            Dungeon_Deaths_1 = Dungeon_data_json["Response"][0]["activities"][number]["values"]["deaths"]["basic"][
                "value"]
            Dungeon_KD_1 = \
                Dungeon_data_json["Response"][0]["activities"][number]["values"]["killsDeathsRatio"]["basic"][
                    "value"]
            Dungeon_KAD_1 = \
                Dungeon_data_json["Response"][0]["activities"][number]["values"]["killsDeathsAssists"]["basic"][
                    "value"]
            Dungeon_Time_1 = \
                Dungeon_data_json["Response"][0]["activities"][number]["values"]["activityDurationSeconds"]["basic"][
                    "value"]
        ...
        for number in range(0, activities_len_2):
            ...
            Dungeon_Kills_2 = Dungeon_data_json["Response"][1]["activities"][number]["values"]["kills"]["basic"][
                "value"]
            Dungeon_Deaths_2 = Dungeon_data_json["Response"][1]["activities"][number]["values"]["deaths"]["basic"][
                "value"]
            Dungeon_KD_2 = \
                Dungeon_data_json["Response"][1]["activities"][number]["values"]["killsDeathsRatio"]["basic"][
                    "value"]
            Dungeon_KAD_2 = \
                Dungeon_data_json["Response"][1]["activities"][number]["values"]["killsDeathsAssists"]["basic"][
                    "value"]
            Dungeon_Time_2 = \
                Dungeon_data_json["Response"][1]["activities"][number]["values"]["activityDurationSeconds"]["basic"][
                    "value"]
        ...
        oneCharDung.add_row(["All Dungeons", Dungeon_Tot_Start, Dungeon_Tot_Comp, Dungeon_Tot_Kills, Dungeon_Tot_Deaths,
                             Time_Converter(Dungeon_Tot_Time)], divider=True)
