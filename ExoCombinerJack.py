...
def ExoCombinerJack():
    ...
    jackExotics = {"Response": []}

    jackExotics['Response'].append(items1)
    jackExotics["Response"].append(items2)
    jackExotics["Response"].append(items3)

    with open('jackExotics.json', "w") as f:
        f.write(json.dumps(jackExotics, indent=2))

    exotic_len_1 = len(jackExotics["Response"][0]['weapons'])
    exotic_len_2 = len(jackExotics["Response"][1]['weapons'])
    exotic_len_3 = len(jackExotics["Response"][2]['weapons'])
    ...
    for number in range(0, exotic_len_1):
        Name_1 = jackExotics["Response"][0]["weapons"][number]["referenceId"]
        Kills_1 = jackExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_1 = \
            jackExotics["Response"][0]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_2):
        Name_2 = jackExotics["Response"][1]["weapons"][number]["referenceId"]
        Kills_2 = jackExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_2 = \
            jackExotics["Response"][1]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
    ...
    for number in range(0, exotic_len_3):
        Name_3 = jackExotics["Response"][2]["weapons"][number]["referenceId"]
        Kills_3 = jackExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponKills"]["basic"]["value"]
        Precision_3 = \
            jackExotics["Response"][2]["weapons"][number]["values"]["uniqueWeaponPrecisionKills"]["basic"]["value"]
