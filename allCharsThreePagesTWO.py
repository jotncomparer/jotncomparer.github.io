...
def URLZeroCTPT(membershipType, destinyMembershipId, characterId, MODE):
...
def URLOneCTPT(membershipType, destinyMembershipId, characterId, MODE):
    url = f"https://www.bungie.net/Platform/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/" \
...
def URLTwoCTPT(membershipType, destinyMembershipId, characterId, MODE):
    url = f"https://www.bungie.net/Platform/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/" \
          f"{characterId}/Stats/Activities/?mode={MODE}&count=250&page=0"
    payload = {}
    headers = {
...
def allCharsThreePagesTWO(MODE):
    if MODE == 4:
        # All Raid Data
        ...
        allCharRaid = PrettyTable()
        allCharRaid.field_names = ["Raid", "Starts", "Completions", "Kills", "Deaths", "Total Time"]
        allCharRaid.add_row(["All Raids", Raid_Tot_Start, Raid_Tot_Comp, Raid_Tot_Kills, Raid_Tot_Deaths,
                             Time_Converter(Raid_Tot_Time)], divider=True)
        allCharRaid.add_row(["Leviathan", Levi_Start, Levi_Comp, Levi_Tot_K, Levi_Tot_D, Time_Converter(Levi_Tot_Time)])
        allCharRaid.add_row(["Eater of Worlds", EoW_Start, EoW_Comp, EoW_Tot_K, EoW_Tot_D,
                             Time_Converter(EoW_Tot_Time)])
        allCharRaid.add_row(["Spire of Stars", SoS_Start, SoS_Comp, SoS_Tot_K, SoS_Tot_D, Time_Converter(SoS_Tot_Time)])
        allCharRaid.add_row(["Crown of Sorrows", Crown_Start, Crown_Comp, Crown_Tot_K, Crown_Tot_D,
                             Time_Converter(Crown_Tot_Time)])
        allCharRaid.add_row(["Scourge of the Past", SotP_Start, SotP_Comp, SotP_Tot_K, SotP_Tot_D,
                             Time_Converter(SotP_Tot_Time)],
                            divider=True)
        allCharRaid.add_row(["Last Wish", LW_Start, LW_Comp, LW_Tot_K, LW_Tot_D, Time_Converter(LW_Tot_Time)])
        allCharRaid.add_row(["Garden of Salvation", GoS_Start, GoS_Comp, GoS_Tot_K, GoS_Tot_D,
                             Time_Converter(GoS_Tot_Time)])
        allCharRaid.add_row(["Deep Stone Crypt", DSC_Start, DSC_Comp, DSC_Tot_K, DSC_Tot_D,
                             Time_Converter(DSC_Tot_Time)])
        allCharRaid.add_row(["Vault of Glass", VoG_Start, VoG_Comp, VoG_Tot_K, VoG_Tot_D, Time_Converter(VoG_Tot_Time)])
        allCharRaid.add_row(["Vow of the Disciple", Vow_Start, Vow_Comp, Vow_Tot_K, Vow_Tot_D,
                             Time_Converter(Vow_Tot_Time)])
        allCharRaid.add_row(["King's Fall", KF_Start, KF_Comp, KF_Tot_K, KF_Tot_D, Time_Converter(KF_Tot_Time)])
        allCharRaid.add_row(["Root of Nightmares", Root_Start, Root_Comp, Root_Tot_K, Root_Tot_D,
        ...
        allCharDung = PrettyTable()
        allCharDung.field_names = ["Dungeon", "Starts", "Completions", "Kills", "Deaths", "Total Time"]
        allCharDung.add_row(["All Dungeons", Dungeon_Tot_Start, Dungeon_Tot_Comp, round(Dungeon_Tot_Kills),
                             round(Dungeon_Tot_Deaths), Time_Converter(Dungeon_Tot_Time)], divider=True)
        allCharDung.add_row(["Shattered Throne", ST_Start, ST_Comp, round(ST_Tot_K), round(ST_Tot_D),
                             Time_Converter(ST_Tot_Time)])
        allCharDung.add_row(["Pit of Heresy", Pit_Start, Pit_Comp, round(Pit_Tot_K), round(Pit_Tot_D),
                             Time_Converter(Pit_Tot_Time)])
        allCharDung.add_row(["Prophecy", Proph_Start, Proph_Comp, round(Proph_Tot_K), round(Proph_Tot_D),
                             Time_Converter(Proph_Tot_Time)])
        allCharDung.add_row(["Grasp of Avarice", Grasp_Start, Grasp_Comp, round(Grasp_Tot_K), round(Grasp_Tot_D),
                             Time_Converter(Grasp_Tot_Time)])
        allCharDung.add_row(["Duality", Duality_Start, Duality_Comp, round(Duality_Tot_K), round(Duality_Tot_D),
                             Time_Converter(Duality_Tot_Time)])
        allCharDung.add_row(["Spire of the Watcher", Spire_Start, Spire_Comp, round(Spire_Tot_K), round(Spire_Tot_D),
                             Time_Converter(Spire_Tot_Time)])
        allCharDung.add_row(["Ghosts of the Deep", GotD_Start, GotD_Comp, round(GotD_Tot_K), round(GotD_Tot_D),
